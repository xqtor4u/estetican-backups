...
class CashReportService implements CashReportServiceInterface
{
    ...
    public function resolveMovementsItems(Request $request, User $user): array
    {
        ...
        // ── Cobros a clientes (payments — tabla única canónica, SYNC-098) ──────
        // Antes se sumaban además cash_ledgers/bank_ledgers del camino web; desde SYNC-098
        // todo cobro (móvil y web) vive en `payments`.
     ...
     * de la misma consulta que ya usa `movements()` — sin duplicar la lógica de las 2 fuentes
     * (CashMovement + Payment; SYNC-098 quitó cash_ledgers/bank_ledgers).
     */
