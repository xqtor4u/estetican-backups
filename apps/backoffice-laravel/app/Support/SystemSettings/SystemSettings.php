...
class SystemSettings
{
    ...
    private function definitions(): array
    {
        return [
            ...
            'ai_assistant' => [
                ...
                'fields' => [
                    ...
                    'ai_assistant_api_key' => [
                        ...
                        'default' => '',
                        'rules' => ['nullable', 'string'],
                        'help' => 'Se guarda cifrada. Dejar en blanco al editar la sección para conservar la que ya está guardada.',
                    ],
                    'ai_assistant_model' => [
                        'label' => 'Modelo',
                        'type' => 'select',
                        ...
                        'options' => [
                            ['value' => 'claude-haiku-4-5-20251001', 'label' => 'Claude Haiku 4.5 (rápido y económico, recomendado)'],
                    ...
                    'ai_assistant_extra_prompt' => [
                        ...
                        'help' => 'Tono, aclaraciones o reglas extra para el asistente (opcional).',
                    ],
                    'ai_assistant_cta_label' => [
                        'label' => 'Texto del botón',
                        'type' => 'text',
                        'default' => 'Agenda tu cita',
                        'rules' => ['nullable', 'string', 'max:60'],
                    ],
                    'ai_assistant_cta_url' => [
                        'label' => 'Enlace del botón',
                        'type' => 'text',
                        'default' => '',
                        'rules' => ['nullable', 'string', 'max:300'],
                        'help' => 'A dónde manda el botón fijo del widget (hoy: WhatsApp o contacto; el día que exista la app de clientes, se cambia solo aquí).',
                    ],
                    'ai_assistant_site_token' => [
                        'label' => 'Token del widget (sitio)',
                        'type' => 'text',
                        'default' => '',
                        'rules' => ['nullable', 'string'],
                        'help' => 'Copiá este valor tal cual al código JS del sitio WordPress. No es un secreto real — queda visible en el código público de la página, solo filtra bots genéricos — por eso, a diferencia de la API Key, sí se muestra aquí para poder copiarlo.',
                    ],
                    'ai_assistant_allowed_origin' => [
                        'label' => 'Dominio permitido (CORS)',
                        'type' => 'text',
                        'default' => '',
                        'rules' => ['nullable', 'string', 'max:200'],
                        'help' => 'Dominio exacto del sitio WordPress, ej. https://www.estetican.org',
                    ],
                ],
            ],
            'system' => [
            ...
            'whatsapp_messaging' => [
                'label' => 'Mensajería de WhatsApp',
                'description' => 'Recordatorios automáticos de cita vía WhatsApp Business Platform (Meta Cloud API). Requiere una plantilla de mensaje aprobada por Meta y un token con permiso whatsapp_business_messaging.',
                'fields' => [
                    'whatsapp_messaging_enabled' => [
                        ...
                        'default' => false,
                        'rules' => ['nullable', 'boolean'],
                        'help' => 'Interruptor maestro. Apagado por default — no se manda nada hasta activarlo a propósito.',
                    ],
                    'whatsapp_messaging_phone_number_id' => [
                        'label' => 'Phone Number ID',
                        'type' => 'text',
                        'default' => '',
                        'rules' => ['nullable', 'string'],
                        'help' => 'Asignado por Meta al número de WhatsApp Business, en WhatsApp Manager.',
                    ],
                    'whatsapp_messaging_access_token' => [
                        'label' => 'Access Token',
                        'type' => 'password',
                        'default' => '',
                        'rules' => ['nullable', 'string'],
                    ...
                    'whatsapp_messaging_template_name' => [
                        'label' => 'Nombre de la plantilla aprobada',
                        'type' => 'text',
                        'default' => '',
                        'rules' => ['nullable', 'string'],
                        'help' => 'Debe coincidir exactamente con el nombre aprobado en WhatsApp Manager.',
                    ],
                    'whatsapp_messaging_template_language' => [
                        'label' => 'Idioma de la plantilla',
                        'type' => 'text',
                        'default' => 'es_MX',
                        'rules' => ['nullable', 'string'],
                        'help' => 'Código de idioma tal como quedó registrado en la plantilla aprobada.',
                    ],
                    'whatsapp_reminder_hours_before' => [
                        'label' => 'Horas de anticipación del recordatorio',
                        'type' => 'number',
                        'default' => 24,
                        'rules' => ['nullable', 'integer', 'min:1'],
                        'help' => 'Cuántas horas antes de la cita se manda el recordatorio automático.',
                    ],
                ],
            ],
            'finanzas' => [
