...
use App\Observers\SpaBookingServiceObserver;
...
#[Fillable(['spa_booking_id', 'service_id', 'service_name_snapshot', 'group_id', 'quantity', 'current_price', 'started_at', 'completed_at', 'cancelled_at', 'cancellation_reason', 'not_performed_at', 'not_performed_reason', 'operator_id', 'scheduled_offset_minutes', 'duration_minutes', 'is_external', 'external_cost'])]
#[ObservedBy(SpaBookingServiceObserver::class)]
