...
<section class="landing-hero position-relative overflow-hidden rounded-4 p-4 p-lg-5 mb-4">
    <div class="row align-items-center g-4 position-relative">
        <div class="col-lg-7">
            <span class="landing-chip mb-3">{{ config('backoffice.brand.shell_title', 'Backoffice operativo') }} 2026-04-18</span>
            <h1 class="display-5 fw-semibold mb-3">Clientes, catálogos, sucursales y la Agenda Universal ya conviven en un flujo fluido.</h1>
            <p class="lead text-white-50 mb-4">
                La portada ahora refleja el baseline real del sistema: flujo comercial operativo, tableros de programación globales mediante el Mago de Reservaciones, y preparación lista para inyectar recursos (Resources).
            </p>
            ...
            <div class="row g-3 mt-2">
                <div class="col-sm-4">
                    <div class="landing-metric rounded-4 p-3 h-100">
                        ...
                        <strong class="landing-metric-value">6 bloques</strong>
                        <small class="d-block text-white-50">Clientes, mascotas, servicios, operadores, sucursales y agenda.</small>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="landing-metric rounded-4 p-3 h-100">
        ...
        <div class="col-lg-5">
            <div class="landing-panel rounded-4 p-4">
                ...
                <div class="d-grid gap-3">
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="fw-semibold">Agenda Universal</span>
                            <span class="badge text-bg-success">Activo</span>
                        </div>
                        <small class="text-secondary-emphasis">Timeline dual (SPA y Hotel) con Mago de Programación Global sin depender del perfil de la mascota.</small>
                    </div>
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <span class="fw-semibold">Resources y Activos</span>
                            <span class="badge text-bg-warning">Siguiente bloque</span>
                        </div>
                        <small class="text-secondary-emphasis">Pendiente aterrizar jaulas, disponibilidad estricta, bloqueos y equipos compartidos.</small>
                    </div>
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-1">
...
<section class="row g-3 mb-4">
    ...
    <div class="col-lg-3 col-md-6">
        <a href="{{ route('agenda.index') }}" class="quick-card quick-card-muted text-decoration-none h-100 d-block rounded-4 p-4">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <span class="quick-card-kicker">Programación</span>
                <span class="badge rounded-pill text-bg-success">Nuevo</span>
            </div>
            <h2 class="h4 mb-2">Agenda Universal</h2>
            <p class="mb-0 text-body-secondary">Programa y visualiza todo tu flujo diario (Hotel y SPA) con un solo mago unificado.</p>
        </a>
    </div>
</section>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="mini-block rounded-4 p-3 h-100">
                            ...
                            <small class="text-body-secondary">Crear `resources`, relaciones y CRUD apoyado en `branches` y amarrado a la nueva `Agenda Universal`.</small>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mini-block rounded-4 p-3 h-100">
