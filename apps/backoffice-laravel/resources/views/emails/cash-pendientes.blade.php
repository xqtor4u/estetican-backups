...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Pendientes por cobrar — {{ $report['generatedAt'] }}</p>
        </div>
        <div class="content">
            <div class="stat-row"><span class="stat-label">Total pendiente</span><span class="stat-value">${{ number_format($report['totalPendiente'], 2) }}</span></div>
            <div class="stat-row"><span class="stat-label">Servicios</span><span class="stat-value">{{ $report['count'] }}</span></div>
            <p style="margin-top: 20px;">El listado completo va adjunto en PDF.</p>
        </div>
        <div class="footer">
