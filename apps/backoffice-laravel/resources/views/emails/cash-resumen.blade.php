...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Resumen de caja — {{ $report['dateFrom'] }} a {{ $report['dateTo'] }}</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="stat-row"><span class="stat-label">Entradas</span><span class="stat-value">${{ number_format($report['totalEntradas'], 2) }}</span></div>
            <div class="stat-row"><span class="stat-label">Salidas</span><span class="stat-value">${{ number_format($report['totalSalidas'], 2) }}</span></div>
            <div class="stat-row"><span class="stat-label">Neto del período</span><span class="stat-value">${{ number_format($report['neto'], 2) }}</span></div>

            <p style="margin-top: 20px;">El desglose completo por tipo de movimiento va adjunto en PDF.</p>
        </div>
