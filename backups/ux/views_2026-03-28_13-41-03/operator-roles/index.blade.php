    ...
    <tbody>
        @forelse($operatorRoles as $operatorRole)
            <tr>
                ...
                <td>
                    <span class="badge {{ $operatorRole->is_active ? 'text-bg-success' : 'text-bg-secondary' }}">
        ...
        @empty
            <tr>
                <td colspan="6" class="text-center py-4 text-body-secondary">Aún no hay tipos de operador registrados.</td>
            </tr>
        @endforelse
    </tbody>
</x-list-table>
