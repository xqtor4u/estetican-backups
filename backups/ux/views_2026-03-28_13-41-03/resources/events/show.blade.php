        ...
        <div class="card h-100">
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-8">{{ optional($event->detected_at)->format('d/m/Y H:i') ?: 'Sin fecha' }}</dd>

                    <dt class="col-sm-4">Ocurrido</dt>
                    <dd class="col-sm-8">{{ optional($event->occurred_at)->format('d/m/Y H:i') ?: 'Sin fecha' }}</dd>
                ...
                <div class="col-md-4">
                    ...
                    <select name="resource_event_update_id" class="form-select">
                        ...
                        @foreach($updateOptions as $updateOption)
                            <option value="{{ $updateOption->id }}">{{ $updateOption->update_type }} · {{ $updateOption->created_at?->format('d/m/Y H:i') }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <div class="mt-2">
                                    ...
                                    <input form="event-photo-form-{{ $photo->id }}" type="file" name="photo" class="form-control" accept="image/*">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <label class="form-label">Tipo</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <select form="event-photo-form-{{ $photo->id }}" name="resource_event_update_id" class="form-select">
                                    <option value="">Sin etapa especifica</option>
                                    @foreach($updateOptions as $updateOption)
                                        <option value="{{ $updateOption->id }}" @selected($photo->resource_event_update_id === $updateOption->id)>{{ $updateOption->update_type }} · {{ $updateOption->created_at?->format('d/m/Y H:i') }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                            ...
                            @if($photo->eventUpdate)
                                <div class="col-12 small text-body-secondary">Ligada a etapa {{ $photo->eventUpdate->update_type }} del {{ $photo->eventUpdate->created_at?->format('d/m/Y H:i') }}</div>
                            @endif
