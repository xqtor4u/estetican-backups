...
@section('content')
<x-page-header eyebrow="Agenda Hotel" title="Reservas hotel" subtitle="Planeación de hospedaje con bloqueo de jaulas por rango.">
    <x-slot:actions>
                    ...
                    <a href="{{ route('hotel-reservations.show', $reservation) }}" class="list-group-item list-group-item-action px-0">
                        <div class="d-flex justify-content-between align-items-start gap-3">
                            <div>
                                ...
                                <div class="small text-body-secondary mt-1">{{ $reservation->start_at?->format('d/m/Y H:i') }} - {{ $reservation->end_at?->format('d/m/Y H:i') }}</div>
                            </div>
